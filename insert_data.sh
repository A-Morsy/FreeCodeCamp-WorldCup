...
do
  ...
  then
    ...
    echo $($PSQL "INSERT INTO games(year, round, winner_id, opponent_id, winner_goals, opponent_goals) VALUES ('$YEAR', '$ROUND', $GAMES_WINNER_ID, $GAMES_OPPONENT_ID, $WINNER_GOALS, $OPPONENT_GOALS);")
  fi
done
